...
**🚀 快速开始？** 查看 [快速开始指南](social-media-automation/QUICK_START.md)
...
3. 配置环境变量
```bash
cp social-media-automation/.env.example social-media-automation/.env.local
...
详细的技术实现请参考 [OAuth实现文档](social-media-automation/docs/oauth.md)。
...
详细的项目演示和功能展示请查看 [Demo文档](social-media-automation/docs/demo.md)
...
本项目采用 MIT 许可证 - 查看 [LICENSE](social-media-automation/LICENSE) 文件了解详情。
